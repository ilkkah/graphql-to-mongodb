        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    projection = requiredQueryOptions.differentOutputType ? undefined : mongoDbProjection_1.getMongoDbProjection(info, graphQLType, requiredQueryOptions);
                    options = { projection: projection };
                    if (args.sort)
                        options.sort = mongoDbSort_1.default(args.sort);
...
function getGraphQLQueryArgs(graphQLType) {
    return {
        ...
        sort: { type: graphQLSortType_1.getGraphQLSortType(graphQLType) },
