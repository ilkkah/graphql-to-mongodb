...
exports.getGraphQLQueryArgs = exports.getMongoDbQueryResolver = void 0;
...
var mongoDbSort_1 = require("./mongoDbSort");
...
function getMongoDbQueryResolver(graphQLType, queryCallback, queryOptions) {
    ...
    var requiredQueryOptions = __assign(__assign({}, defaultOptions), queryOptions);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    projection = requiredQueryOptions.differentOutputType ? undefined : (0, mongoDbProjection_1.getMongoDbProjection)(info, graphQLType, requiredQueryOptions);
                    options = { projection: projection };
                    if (args.sort)
                        options.sort = (0, mongoDbSort_1.default)(args.sort);
...
function getGraphQLQueryArgs(graphQLType) {
    return {
        filter: { type: (0, graphQLFilterType_1.getGraphQLFilterType)(graphQLType) },
        sort: { type: (0, graphQLSortType_1.getGraphQLSortType)(graphQLType) },
